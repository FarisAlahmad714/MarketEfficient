...
export const STRIPE_CONFIG = {
  products: {
    monthly: {
      name: 'ChartSense Monthly Subscription',
      description: 'Monthly access to ChartSense trading platform',
      priceId: process.env.STRIPE_MONTHLY_PRICE_ID, // Will be set after creating in Stripe
      amount: 3900, // $39.00 in cents
      interval: 'month'
    },
    annual: {
      name: 'ChartSense Annual Subscription',
      description: 'Annual access to ChartSense trading platform (Save $108)',
