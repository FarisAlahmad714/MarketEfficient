export const studyContent = {
  // ====== PSYCHOLOGY & BIASES (BEGINNER) ======
  "Trading Psychology & Cognitive Biases": {
    level: "beginner",
    icon: "fas fa-brain",
    description: "Master the mental game first - understand the psychological traps that destroy trading accounts",
    ...
    lessons: {
      "The 7 Deadly Trading Biases": {
        content: `
          <div class="lesson-intro">
            <p>Most trading failures aren't due to lack of technical knowledge. They're caused by predictable psychological biases that cloud judgment and lead to poor decisions. Understanding these biases is the first step to overcoming them.</p>
            <img src="/images/trading-biases-overview.png" alt="Trading Biases Overview" class="lesson-image" />
          </div>
          
          <div class="bias-section">
            <h4>1. Confirmation Bias - Seeking What You Want to Hear</h4>
            <div class="bias-explanation">
              <p>This bias causes traders to actively seek information that supports their existing position while ignoring contradictory evidence. It's why traders hold losing positions far too long.</p>
              
              <div class="real-scenario">
                <h5>Real Example:</h5>
                <p>You're long Bitcoin at $45,000. Price drops to $43,000. Instead of reassessing your position, you scroll through social media looking for bullish takes while ignoring bearish technical signals. You add to your losing position instead of cutting the loss.</p>
                <img src="/images/confirmation-bias-chart.png" alt="Confirmation Bias Example" class="lesson-image" />
                
                <div class="multi-asset-comparison">
                  <h6>This Bias Affects All Markets:</h6>
                  <ul>
                    <li><strong>Stocks:</strong> Bought NVDA at $500, falls to $480. Investors focus on AI hype while missing semiconductor cycle downturn signals.</li>
                    <li><strong>Indices:</strong> Long S&P 500 at 4,600, drops to 4,450. Traders seek bullish Fed commentary while ignoring weakening earnings.</li>
                    <li><strong>Commodities:</strong> Long Oil at $85, drops to $80. Traders highlight OPEC supply cuts while ignoring demand destruction data.</li>
                  </ul>
                </div>
              </div>
              ...
              <div class="practice-box">
                ...
                <p>Look at this chart without knowing the asset name. What direction do you think it's heading? Write down your analysis before proceeding.</p>
                <img src="/images/bias-test-practice-1.png" alt="Practice Chart 1" class="lesson-image" />
              </div>
            </div>

            <h4>2. Recency Bias - Overweighting Recent Events</h4>
            <div class="bias-explanation">
              <p>Recent events feel more important than they actually are. After a strong rally, traders expect it to continue indefinitely, ignoring that markets are cyclical.</p>
              
              <div class="real-scenario">
                <h5>Common Pattern:</h5>
                <p>Tesla rallies 40% in a month. Retail traders pile in at the top because "it's on fire," ignoring that the smart money bought at the bottom and is now distributing to late buyers.</p>
                <img src="/images/recency-bias-chart.png" alt="Recency Bias Example" class="lesson-image" />
                
                <div class="multi-asset-comparison">
                  <h6>Recency Bias Across Markets:</h6>
                  <ul>
                    <li><strong>Crypto:</strong> After Bitcoin's 100% rally, traders expect endless gains, buying at $69,000 tops.</li>
                    <li><strong>Tech Stocks:</strong> TSLA gains 200% in months, retail piles in at $400 expecting infinite growth.</li>
                    <li><strong>Commodities:</strong> Gold rallies to $2,000, investors buy at highs assuming safe-haven demand continues forever.</li>
                  </ul>
                </div>
              </div>
            </div>

            <h4>3. Anchoring Bias - Fixation on Irrelevant Numbers</h4>
            <div class="bias-explanation">
              <p>Traders become anchored to specific price levels (often their entry price) even when those levels have no current market relevance.</p>
              
              <div class="real-scenario">
                <h5>Typical Scenario:</h5>
                <p>You bought Gold at $1,850. It drops to $1,800. Instead of analyzing current market conditions, you obsess over "getting back to breakeven" at $1,850 - a level that means nothing to the market.</p>
                
                <div class="multi-asset-comparison">
                  <h6>Anchoring Examples Across Assets:</h6>
                  <ul>
                    <li><strong>Stocks:</strong> Anchored to AAPL purchase at $175, ignoring new support at $165 after market structure shift.</li>
                    <li><strong>Commodities:</strong> Fixated on Silver entry at $25, missing new accumulation zone between $22-23.</li>
                    <li><strong>Indices:</strong> Obsessed with NASDAQ entry at 15,000, blind to new range between 14,200-14,600.</li>
                  </ul>
                </div>
              </div>
            </div>

            <h4>4. Loss Aversion - Holding Losers, Cutting Winners</h4>
            <div class="bias-explanation">
              <p>Humans feel losses twice as intensely as equivalent gains. This leads to holding losing positions hoping to avoid realizing the loss, while cutting profitable trades too early.</p>
              
              <div class="stat-highlight">
                <p>Research shows traders hold losing positions 50% longer than winning positions on average.</p>
              </div>
            </div>

            <h4>5. Overconfidence Bias - Success Breeds Recklessness</h4>
            <div class="bias-explanation">
              <p>After a string of winning trades, confidence turns into overconfidence. Position sizes increase, risk management gets abandoned, and previously disciplined traders start gambling.</p>
              
              <div class="warning-box">
                <h5>Warning Signs:</h5>
                <ul>
                  <li>Increasing position size after wins</li>
                  <li>Skipping stop losses because you "know" it'll work</li>
                  <li>Trading based on gut feeling rather than analysis</li>
                  <li>Thinking you've figured out the market</li>
                </ul>
              </div>
            </div>

            <h4>6. Herd Mentality - Following the Crowd</h4>
            <div class="bias-explanation">
              <p>When everyone seems bullish or bearish, there's pressure to follow. This creates buying at tops and selling at bottoms - exactly when you should be doing the opposite.</p>
              
              <div class="real-scenario">
                <h5>Historical Example:</h5>
                <p>During the 2021 crypto peak, retail FOMO reached extreme levels around $60,000+ Bitcoin. Smart money was already distributing to the crowd.</p>
              </div>
            </div>

            <h4>7. FOMO - Fear of Missing Out</h4>
            <div class="bias-explanation">
              <p>FOMO drives traders to chase moves that have already happened, entering at the worst possible prices just before reversals.</p>
              
              <div class="practice-box">
                <h5>FOMO Check Questions:</h5>
                <p>Before entering any trade based on urgency:</p>
                <ol>
                  <li>Am I chasing a move that already happened?</li>
                  <li>Where was the ideal entry point?</li>
                  <li>What's my actual risk/reward from current levels?</li>
                </ol>
              </div>
            </div>
          </div>

          <div class="bias-defense-strategies">
            <h4>Building Bias Defense Systems</h4>
            <div class="strategy-grid">
              <div class="strategy-card">
                <h5>Pre-Trade Protocol</h5>
                <ul>
                  <li>Write analysis before checking price direction</li>
                  <li>Set stops and targets before entering</li>
                  <li>Ask: "What would invalidate this trade?"</li>
                </ul>
              </div>
              <div class="strategy-card">
                <h5>During-Trade Discipline</h5>
                <ul>
                  <li>Avoid constantly checking unrealized P&L</li>
                  <li>Stick to your original plan</li>
                  <li>Step away when emotions run high</li>
                </ul>
              </div>
              <div class="strategy-card">
                <h5>Post-Trade Analysis</h5>
                <ul>
                  <li>Journal which bias affected you</li>
                  <li>Grade execution, not outcome</li>
          ...
          <div class="ready-to-test">
            <h4>Test Your Psychological Readiness</h4>
            <p>The Bias Test presents real market scenarios designed to expose these psychological traps. Can you trade objectively under pressure?</p>
            <a href="/bias-test/BTCUSDT" class="test-link">
        ...
        `,
        quiz: {
          question: "Which bias causes traders to hold losing positions too long while hoping to avoid realizing the loss?",
          options: [
            "Confirmation bias",
            "Loss aversion",
            "Overconfidence bias", 
          ...
          correct: 2,
          explanation: "Loss aversion makes losses feel twice as painful as gains feel good, causing traders to hold losers hoping to avoid realizing the loss."
        }
      },
      ...
      "FOMO and Revenge Trading": {
        content: `
          <div class="lesson-intro">
            <p>FOMO and revenge trading are emotional responses that destroy more accounts than technical analysis failures. Learning to recognize and control these impulses is essential for long-term success.</p>
            <img src="/images/fomo-revenge-cycle.png" alt="FOMO and Revenge Trading Cycle" class="lesson-image" />
          </div>

          <div class="concept-section">
            <h4>The FOMO Trading Cycle</h4>
            <div class="fomo-stages">
              <div class="stage-card">
                <h5>Stage 1: The Trigger</h5>
                <p>You see an asset that moved significantly while you weren't positioned. Your brain immediately thinks you're missing easy money.</p>
                <img src="/images/fomo-stage-1.png" alt="FOMO Trigger" class="lesson-image" />
              </div>
              
              <div class="stage-card">
                <h5>Stage 2: The Rationalization</h5>
                <p>You start finding reasons why the move will continue: "It's breaking out!" "Volume is increasing!" - while ignoring risk/reward analysis.</p>
              </div>
              
              <div class="stage-card">
                <h5>Stage 3: The Chase</h5>
                <p>You enter at any price, usually at resistance levels, often without a stop loss plan. Position size may be too large to "make up for missed gains."</p>
              </div>
              
              <div class="stage-card">
                <h5>Stage 4: The Reversal</h5>
                <p>Price reverses shortly after your entry. You provided exit liquidity for smart money and are now trapped in a losing position.</p>
                <img src="/images/fomo-reversal.png" alt="FOMO Reversal" class="lesson-image" />
              </div>
            </div>

            <h4>Revenge Trading - The Account Killer</h4>
            <p>Revenge trading occurs when emotions override logic after a loss. The desire to "get back" at the market or quickly recover losses leads to increasingly poor decisions.</p>
            
            <div class="revenge-characteristics">
              <h5>Revenge Trading Warning Signs:</h5>
              <ul>
                <li>Immediately entering new trades after a loss</li>
                <li>Doubling position size to recover faster</li>
                <li>Abandoning your trading strategy</li>
                <li>Trading unfamiliar assets</li>
                <li>Feeling angry at the market</li>
                <li>Thoughts like "just one more trade" or "I'll show the market"</li>
              </ul>
            </div>

            <div class="cycle-breaker">
              <h4>Breaking the Destructive Cycle</h4>
              <div class="technique-grid">
                <div class="technique-card">
                  <h5>The Cooling-Off Period</h5>
                  <p>After significant losses, implement a mandatory waiting period before trading again. This allows emotions to settle and logic to return.</p>
                </div>
                <div class="technique-card">
                  <h5>Opportunity Mindset</h5>
                  <p>Money you "could have made" isn't real. Focus only on actual opportunities with proper risk/reward analysis.</p>
                </div>
                <div class="technique-card">
                  <h5>Loss Limits</h5>
                  <p>Set daily and weekly loss limits. When hit, stop trading immediately. This prevents revenge spirals from escalating.</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="practice-section">
            <h4>FOMO Recognition Practice</h4>
            <div class="scenario-practice">
              <p>Identify which scenarios show FOMO behavior:</p>
              <ol>
                <li>Bitcoin pumps 15% overnight. You market buy immediately at open.</li>
                <li>You wait for a pullback to the 50% retracement before entering.</li>
                <li>Your friend made 50% on a token. You buy without research.</li>
                <li>You see a breakout but wait for retest before entering.</li>
                <li>Tesla jumps 10% on earnings. You chase at market open without plan.</li>
                <li>Gold spikes on geopolitical news. You analyze support levels before entry.</li>
              </ol>
              <details>
                <summary>Check Your Analysis</summary>
                <p>FOMO behaviors: 1, 3, and 5. Disciplined approaches: 2, 4, and 6.</p>
              </details>
            </div>
          </div>
        `,
        quiz: {
          question: "What's the most effective way to prevent revenge trading after a loss?",
          options: [
            "Immediately enter a new trade to recover",
            "Double your position size on the next trade",
            "Implement a mandatory cooling-off period",
            "Switch to a different trading strategy"
          ],
          correct: 3,
          explanation: "A mandatory cooling-off period allows emotions to settle and prevents impulsive revenge trades that often lead to larger losses."
        }
      },
      ...
      "Objective Chart Analysis": {
        content: `
          <div class="lesson-intro">
            <p>Learning to analyze charts without emotional bias is what separates successful traders from the majority who fail. This requires systematic approaches that remove subjective interpretation.</p>
            <img src="/images/objective-analysis.png" alt="Objective Chart Analysis" class="lesson-image" />
          </div>

          <div class="technique-section">
            <h4>The Blind Chart Method</h4>
            <p>Professional traders often analyze charts without knowing the asset name. This eliminates emotional attachment and preconceived biases about specific instruments.</p>
            
            <div class="method-steps">
              <h5>Implementation Process:</h5>
              <ol>
                <li>Cover the symbol/asset name on your charts</li>
                <li>Analyze structure, patterns, and key levels</li>
                <li>Make your trading decision based purely on price action</li>
                <li>Only then reveal what asset you're analyzing</li>
              </ol>
              <p class="highlight-box">If your analysis changes after knowing the asset, you're trading with bias.</p>
            </div>

            <h4>Systematic Analysis Framework</h4>
            <p>Before every trade, complete this objective checklist:</p>
            <div class="checklist-box">
              <label><input type="checkbox"> Market structure: Bullish, bearish, or neutral?</label>
              <label><input type="checkbox"> Key levels identified and marked</label>
              <label><input type="checkbox"> Risk/reward ratio calculated (minimum 1:2)</label>
              <label><input type="checkbox"> Position size based on account percentage</label>
              <label><input type="checkbox"> Stop loss at logical technical level</label>
              <label><input type="checkbox"> Would I take this trade without monitoring for 24 hours?</label>
            </div>
          </div>

          <div class="emotional-triggers">
            <h4>Recognizing Emotional vs. Objective Analysis</h4>
            <div class="trigger-grid">
              <div class="trigger-card bad">
                <h5>Emotional Trader Language:</h5>
                <ul>
                  <li>"It has to bounce here"</li>
                  <li>"This always goes up"</li>
                  <li>"I feel like it's going higher"</li>
                  <li>"It can't go any lower"</li>
                  <li>"The news says..."</li>
                </ul>
              </div>
              <div class="trigger-card good">
                <h5>Objective Trader Language:</h5>
                <ul>
                  <li>"Price is at support, watching for reaction"</li>
                  <li>"Historical data suggests..."</li>
                  <li>"Technical indicators show..."</li>
                  <li>"Stop loss at X, target at Y"</li>
                  <li>"Chart structure indicates..."</li>
                </ul>
              </div>
            </div>
          </div>
          ...
          <div class="practice-exercise">
            <h4>Objectivity Training Exercise</h4>
            <p>For the next week, before entering any trade:</p>
            <ol>
              <li>Write your analysis using only technical terms</li>
              <li>Avoid words like "feel," "think," "hope," or "should"</li>
              <li>Explain your analysis to someone using only facts</li>
              <li>If you can't explain it objectively, don't trade it</li>
            </ol>
          </div>

          <div class="ready-to-test">
            <h4>Test Your Objectivity</h4>
            <p>The Bias Test presents scenarios where emotional traders typically fail. Can you maintain objectivity under pressure?</p>
            <a href="/bias-test/ETHUSD" class="test-link">
        ...
        `,
        quiz: {
          question: "What's the primary benefit of analyzing charts without knowing the asset name?",
          options: [
            "It's faster to analyze",
            "It eliminates emotional attachment and preconceived biases",
            "It's not beneficial",
            "It helps memorize patterns"
          ],
          correct: 2,
          explanation: "Analyzing unnamed charts eliminates emotional attachment and preconceived notions about specific assets, leading to more objective technical analysis."
        }
      }
    }
  },

  // ====== SANDBOX PREPARATION (BEGINNER) ======
  "Paper Trading Mastery": {
    level: "beginner", 
    icon: "fas fa-coins",
    description: "Master risk-free trading with $10,000 virtual capital - learn position sizing, leverage management, and quarterly performance reviews",
    ...
    lessons: {
      "Your First $10,000 Trading Account": {
        content: `
          <div class="lesson-intro">
            <p>Welcome to your sandbox trading account starting with $10,000 in virtual capital. This mirrors realistic starting capital for most traders while providing a safe environment to develop skills without financial risk.</p>
            <img src="/images/sandbox-welcome.png" alt="Sandbox Trading Interface" class="lesson-image" />
          </div>

          <div class="sandbox-overview">
            <h4>Your Sandbox Trading Environment</h4>
            <div class="sandbox-rules">
              <h5>Account Features:</h5>
              <ul>
                <li>Starting Capital: $10,000 (virtual)</li>
                <li>Real-time market data from actual exchanges</li>
                <li>Leverage available up to 100x (use carefully)</li>
                <li>Long and short positions on crypto pairs</li>
                <li>Automated stop-loss and take-profit execution</li>
                <li>Live P&L tracking with performance analytics</li>
                <li>Quarterly performance reviews and capital top-ups</li>
              </ul>
              
              <div class="unlock-requirement">
                <p><strong>Access Requirement:</strong> Complete the Bias Test first to unlock sandbox trading. This ensures you understand psychological challenges before practicing with positions.</p>
                <a href="/bias-test/BTCUSDT" class="unlock-link">Complete Bias Test to Unlock</a>
              </div>
            </div>

            <h4>The Quarterly System - Your Built-In Safety Net</h4>
            <div class="quarterly-system">
              <h5>Performance Reviews Every 3 Months</h5>
              <p>Every quarter, your account receives an automatic $10,000 top-up, giving you a fresh start while maintaining your trading history. This unique system ensures you can always recover from mistakes and continue learning.</p>
              
              <div class="quarterly-benefits">
                <h6>Why This System Works:</h6>
                <ul>
                  <li>Removes fear of "blowing up" permanently</li>
                  <li>Encourages learning from mistakes without devastating consequences</li>
                  <li>Tracks long-term improvement across multiple quarters</li>
                  <li>Simulates real-world capital injections traders might receive</li>
                </ul>
              </div>
            </div>

            <h4>Position Sizing with $10,000 Capital</h4>
            <div class="position-sizing-guide">
              <h5>The 1-2% Risk Rule for Smaller Accounts</h5>
              <p>With $10,000, risking 1-2% per trade ($100-$200) is appropriate. This gives you 50-100 trades before depleting capital - plenty of room to learn and make mistakes.</p>
              
              <div class="calculation-example">
                <h6>Realistic Position Size Calculation:</h6>
                <div class="calc-box">
                  <p><strong>Example Setup:</strong> Long Bitcoin at $45,000, Stop Loss at $44,550</p>
                  <p><strong>Risk per coin:</strong> $45,000 - $44,550 = $450</p>
                  <p><strong>Maximum account risk:</strong> $10,000 × 1% = $100</p>
                  <p><strong>Position size:</strong> $100 ÷ $450 = 0.00022 BTC (about $100 position)</p>
                </div>
                <p class="highlight-box">With smaller capital, position sizes are naturally limited. This forces disciplined trading and prevents overexposure.</p>
              </div>

              <div class="leverage-warning">
                <h5>Leverage Management with Smaller Capital</h5>
                <p>With $10,000 capital, leverage becomes even more dangerous. High leverage can wipe out your entire quarterly allocation in minutes.</p>
                <div class="leverage-examples">
                  <div class="leverage-example bad">
                    <h6>Account Killer: 25x Leverage</h6>
                    <p>$200 position with 25x leverage = $5,000 exposure. A 2% adverse move = -$100, but a 4% move = -$200 (entire position gone).</p>
                  </div>
                  <div class="leverage-example good">
                    <h6>Safer Approach: 2-5x Leverage</h6>
                    <p>$200 position with 3x leverage = $600 exposure. Requires 17% adverse move to lose $100. Much more survivable.</p>
                  </div>
                </div>
              </div>
            </div>

            <h4>Essential Order Types</h4>
            <div class="order-types-guide">
              <div class="order-type">
                <h5>Market Orders</h5>
                <p>Execute immediately at current market price. Use for urgent entries/exits or when price action demands immediate response.</p>
                <div class="when-to-use">
                  <strong>Best for:</strong> Breaking news reactions, stop loss triggers, profit-taking at targets.
                </div>
              </div>

              <div class="order-type">
                <h5>Stop Loss Orders</h5>
                <p>Automatically close positions when price reaches your predetermined loss limit. Always set before entering trades.</p>
                <div class="stop-loss-tips">
                  <strong>Placement Guidelines:</strong>
                  <ul>
                    <li>Place beyond technical levels, not at round numbers</li>
                    <li>Never move stops against your position</li>
              ...
              <div class="order-type">
                <h5>Take Profit Orders</h5>
                <p>Automatically close profitable positions at predetermined targets. Removes emotion from profit-taking decisions.</p>
                <div class="profit-taking-strategy">
                  <strong>Target Setting:</strong> Minimum 2:1 risk/reward ratio. Risk $100, target $200+ profit.
                </div>
              </div>
            </div>

            <h4>Trading Scenario Analysis</h4>
            <div class="practice-scenarios">
              <div class="scenario">
                <h5>Scenario 1: Bitcoin Breakout</h5>
                <p>Bitcoin breaks above $46,000 resistance with volume confirmation. You anticipate continuation to $48,000.</p>
                <div class="scenario-questions">
                  <p><strong>Planning Questions:</strong></p>
                  <ol>
                    <li>Where would you place your stop loss?</li>
                    <li>What position size maintains proper risk management?</li>
                    <li>What's your risk/reward ratio?</li>
                  </ol>
                  <details>
                    <summary>Professional Approach</summary>
                    <div class="professional-answer">
                      <ul>
                        <li><strong>Entry:</strong> $46,100 (confirmation above breakout)</li>
                        <li><strong>Stop Loss:</strong> $45,500 (below breakout invalidation)</li>
                        <li><strong>Target:</strong> $47,300 (2:1 risk/reward)</li>
                        <li><strong>Risk per Bitcoin:</strong> $600</li>
                        <li><strong>Position Size:</strong> 0.0017 BTC ($1,000 ÷ $600)</li>
                      </ul>
                    </div>
                  </details>
                </div>
              ...
              <div class="scenario">
                <h5>Scenario 2: Ethereum Short Setup</h5>
                <p>Ethereum rejects at $3,200 resistance for the third time. You see potential decline to $2,900.</p>
                <div class="scenario-questions">
                  <p><strong>Short Trade Planning:</strong></p>
                  <ol>
                    <li>Where does the stop loss go for short positions?</li>
                    <li>How do short mechanics work in the sandbox?</li>
                    <li>What differs between long and short position management?</li>
                  </ol>
                  <details>
                    <summary>Short Trading Strategy</summary>
                    <div class="professional-answer">
                      <ul>
                        <li><strong>Short Entry:</strong> $3,180 (below rejection confirmation)</li>
                        <li><strong>Stop Loss:</strong> $3,250 (above resistance invalidation)</li>
                        <li><strong>Target:</strong> $3,040 (2:1 risk/reward)</li>
                        <li><strong>Risk per Ethereum:</strong> $70</li>
                        <li><strong>Position Size:</strong> 14.3 ETH ($1,000 ÷ $70)</li>
                      </ul>
                      <p><strong>Short Note:</strong> Profit from price decline. Stop losses go above entry price.</p>
                    </div>
                  </details>
                </div>
              </div>
              ...
              <div class="scenario">
                <h5>Scenario 3: Apple Earnings Breakout</h5>
                <p>Apple reports strong earnings and gaps above $190 resistance with heavy volume. Previous resistance was at $187.</p>
                <div class="scenario-questions">
                  <p><strong>Stock Trading Considerations:</strong></p>
                  <ol>
                    <li>How do earnings gaps differ from technical breakouts?</li>
                    <li>Where should stops be placed on gap trades?</li>
                    <li>What's the optimal position size for stock trades?</li>
                  </ol>
                  <details>
                    <summary>Stock Trading Approach</summary>
                    <div class="professional-answer">
                      <ul>
                        <li><strong>Entry:</strong> $191 (after gap confirmation)</li>
                        <li><strong>Stop Loss:</strong> $188 (below gap fill level)</li>
                        <li><strong>Target:</strong> $197 (2:1 risk/reward)</li>
                        <li><strong>Risk per Share:</strong> $3</li>
                        <li><strong>Position Size:</strong> 33 shares ($100 ÷ $3)</li>
                      </ul>
                      <p><strong>Stock Note:</strong> Earnings gaps often hold as support. Use pre-market levels for entries.</p>
                    </div>
                  </details>
                </div>
              </div>
              ...
              <div class="scenario">
                <h5>Scenario 4: Gold Safe Haven Rally</h5>
                <p>Gold breaks above $1,950 on geopolitical tensions. Historical resistance was $1,920-1,930 zone.</p>
                <div class="scenario-questions">
                  <p><strong>Commodity Trading Strategy:</strong></p>
                  <ol>
                    <li>How do commodities react to news differently than stocks?</li>
                    <li>What's the typical volatility range for gold?</li>
                    <li>How to size positions in commodity markets?</li>
                  </ol>
                  <details>
                    <summary>Commodity Trading Methods</summary>
                    <div class="professional-answer">
                      <ul>
                        <li><strong>Entry:</strong> $1,955 (breakout confirmation)</li>
                        <li><strong>Stop Loss:</strong> $1,935 (below breakout zone)</li>
                        <li><strong>Target:</strong> $1,995 (2:1 risk/reward)</li>
                        <li><strong>Risk per Ounce:</strong> $20</li>
                        <li><strong>Position Size:</strong> 5 ounces ($100 ÷ $20)</li>
                      </ul>
                      <p><strong>Gold Note:</strong> Safe haven flows can sustain longer than technical moves. Watch USD correlation.</p>
                    </div>
                  </details>
                </div>
              </div>
            ...
            <h4>Portfolio Management for $10,000 Accounts</h4>
            <div class="portfolio-rules">
              <div class="rule-card">
                <h5>Position Limits</h5>
                <p>Maximum 2-3 open positions with smaller capital. Each position needs proper attention, and overtrading kills small accounts faster.</p>
              </div>
              <div class="rule-card">
                <h5>Total Risk Management</h5>
                <p>Combined risk across all positions should not exceed 3-5% of account. With $10k, maximum $300-500 total risk across all trades.</p>
              </div>
              <div class="rule-card">
                <h5>Cross-Asset Correlation Awareness</h5>
                <p>Understand market correlations to avoid concentrated risk:</p>
                <ul>
                  <li><strong>Crypto:</strong> BTC and ETH move together 80%+ of the time</li>
                  <li><strong>Tech Stocks:</strong> FAANG stocks often move in tandem during sector rotations</li>
                  <li><strong>Commodities:</strong> Gold and Silver typically correlate, Oil inversely correlates with USD</li>
                  <li><strong>Risk-On/Off:</strong> Stocks and crypto rise together in risk-on, Gold rises in risk-off</li>
                </ul>
              </div>
              <div class="rule-card">
                <h5>Quarterly Performance Tracking</h5>
                <p>Your goal is quarterly profitability. Track performance across each 3-month period to see genuine improvement over time.</p>
              </div>
            </div>

            <div class="ready-to-practice">
              <h4>Begin Paper Trading</h4>
              <p>Apply theoretical knowledge in a practical environment with real market conditions and zero financial risk.</p>
              <div class="sandbox-link-container">
                <a href="/sandbox" class="sandbox-link">
                  <i class="fas fa-coins"></i>
                  Enter Sandbox
                </a>
                <p class="unlock-note">Complete Bias Test first to unlock access</p>
              </div>
            </div>
          </div>
        `,
        quiz: {
          question: "Using the 1% rule with a $10,000 sandbox account, what's the maximum risk per trade?",
          options: [
            "$50",
            "$100",
            "$200", 
          ...
          correct: 2,
          explanation: "The 1% rule limits risk to 1% of account balance per trade. 1% of $10,000 = $100 maximum risk per trade."
        }
      }
    }
  },
  ...
  "Market Basics: How Trading Works": {
    ...
    description: "Understand the mechanics of financial markets, order types, and how trades are executed across different asset classes",
    ...
    lessons: {
      "How Markets Function": {
        content: `
          <div class="lesson-intro">
            <p>Before diving into strategies, you must understand how financial markets actually work. This foundation will help you make informed decisions regardless of which asset you trade.</p>
            <img src="/images/market-basics-overview.png" alt="Market Basics" class="lesson-image" />
          </div>
          
          <div class="market-mechanics">
            <h4>The Trading Ecosystem</h4>
            <h5>Market Participants</h5>
            <p>Financial markets consist of various participants, each with different goals and resources:</p>
            <ul>
              <li><strong>Retail Traders:</strong> Individual traders like you, typically trading smaller positions</li>
              <li><strong>Institutional Traders:</strong> Banks, hedge funds, and large firms with massive capital</li>
              <li><strong>Market Makers:</strong> Provide liquidity by constantly buying and selling</li>
              <li><strong>Algorithmic Systems:</strong> Automated trading programs executing pre-programmed strategies</li>
            </ul>
            
            <h5>How Prices Move</h5>
            <p>Prices move based on supply and demand imbalances. When more traders want to buy than sell, prices rise. When selling pressure exceeds buying interest, prices fall. This applies universally across all markets.</p>
            
            <div class="multi-asset-comparison">
              <h6>Price Discovery Across Markets:</h6>
              <ul>
                <li><strong>Stocks:</strong> Centralized exchanges (NYSE, NASDAQ) match buyers and sellers</li>
                <li><strong>Crypto:</strong> Decentralized exchanges and CEXs operate 24/7 globally</li>
                <li><strong>Commodities:</strong> Futures exchanges (CME, ICE) set benchmark prices</li>
              </ul>
            </div>
          </div>

          <div class="order-mechanics">
            <h4>Understanding Order Types</h4>
            <div class="order-type-grid">
              <div class="order-type-card">
                <h5>Market Orders</h5>
                <p>Execute immediately at the best available price. Fast but no price guarantee.</p>
                <div class="order-example">
                  <p><strong>Example:</strong> "Buy 100 shares of AAPL at market" - fills instantly at current ask price</p>
                </div>
              </div>
              
              <div class="order-type-card">
                <h5>Limit Orders</h5>
                <p>Execute only at your specified price or better. Price control but no fill guarantee.</p>
                <div class="order-example">
                  <p><strong>Example:</strong> "Buy 100 shares of AAPL at $150 limit" - only fills if price reaches $150 or lower</p>
                </div>
              </div>
              
              <div class="order-type-card">
                <h5>Stop Orders</h5>
                <p>Trigger a market order when price reaches specified level. Used for exits and entries.</p>
                <div class="order-example">
                  <p><strong>Example:</strong> "Sell 100 shares of AAPL at $145 stop" - becomes market order if price drops to $145</p>
                </div>
              </div>
              
              <div class="order-type-card">
                <h5>Stop-Limit Orders</h5>
                <p>Trigger a limit order when stop price is reached. Combines stop and limit features.</p>
                <div class="order-example">
                  <p><strong>Example:</strong> "Sell at $145 stop, $144 limit" - triggers at $145, only fills at $144 or better</p>
                </div>
              </div>
            </div>
          </div>

          <div class="execution-concepts">
            <h4>Trade Execution Realities</h4>
            <h5>Bid-Ask Spread</h5>
            <p>The difference between buying price (ask) and selling price (bid). This spread is a hidden cost in every trade:</p>
            <ul>
              <li><strong>Tight Spreads:</strong> Liquid assets like Apple stock ($0.01-0.02 spread)</li>
              <li><strong>Wide Spreads:</strong> Illiquid assets or volatile conditions ($0.10+ spreads)</li>
              <li><strong>Impact:</strong> You lose the spread immediately upon entry</li>
            </ul>
            
            <h5>Slippage</h5>
            <p>The difference between expected and actual execution price. Common causes:</p>
            <ul>
              <li>Fast-moving markets during news events</li>
              <li>Large orders exhausting available liquidity</li>
              <li>Low liquidity periods (after-hours, pre-market)</li>
            </ul>
          </div>
        `,
        quiz: {
          ...
          correct: 2,
          explanation: "Market orders execute immediately at the best available price, guaranteeing execution but not a specific price."
        }
      },
      ...
      "Market Sessions and Timing": {
        content: `
          <div class="lesson-intro">
            <p>Different markets operate on different schedules, and understanding these timing dynamics is crucial for successful trading.</p>
            <img src="/images/market-sessions.png" alt="Global Market Sessions" class="lesson-image" />
          </div>
          
          <div class="session-overview">
            <h4>Global Trading Sessions</h4>
            <div class="session-timeline">
              <div class="session-block">
                <h5>Stock Market Hours</h5>
                <ul>
                  <li><strong>Pre-Market:</strong> 4:00 AM - 9:30 AM EST (limited liquidity)</li>
                  <li><strong>Regular Hours:</strong> 9:30 AM - 4:00 PM EST (full liquidity)</li>
                  <li><strong>After-Hours:</strong> 4:00 PM - 8:00 PM EST (reduced liquidity)</li>
                  <li><strong>Closed:</strong> Weekends and market holidays</li>
                </ul>
                <p class="session-note">Earnings releases often occur outside regular hours, creating gaps</p>
              </div>
              
              <div class="session-block">
                <h5>Cryptocurrency Markets</h5>
                <ul>
                  <li><strong>Trading Hours:</strong> 24/7/365 - never closes</li>
                  <li><strong>Peak Volume:</strong> During US and Asian market overlaps</li>
                  <li><strong>Weekend Trading:</strong> Often lower volume, higher volatility</li>
                  <li><strong>No Circuit Breakers:</strong> Can move 20%+ in minutes</li>
                </ul>
                <p class="session-note">Crypto's continuous trading requires different risk management</p>
              </div>
              
              <div class="session-block">
                <h5>Commodity Markets</h5>
                <ul>
                  <li><strong>Gold/Silver:</strong> Sunday 6PM - Friday 5PM EST (nearly 24-hour)</li>
                  <li><strong>Oil:</strong> Sunday 6PM - Friday 5PM EST</li>
                  <li><strong>Agricultural:</strong> Specific hours per commodity</li>
                  <li><strong>Settlement:</strong> Daily settlement prices affect positions</li>
                </ul>
                <p class="session-note">Commodities react strongly to supply/demand reports released at specific times</p>
              </div>
            </div>
            
            <h4>Why Timing Matters</h4>
            <div class="timing-factors">
              <h5>Liquidity Variations</h5>
              <p>Trading volume changes dramatically throughout the day:</p>
              <ul>
                <li><strong>Market Open (9:30-10:30 AM):</strong> Highest volume, most volatility</li>
                <li><strong>Midday (11:30-2:00 PM):</strong> Lower volume, smaller moves</li>
                <li><strong>Market Close (3:00-4:00 PM):</strong> Volume surge, positioning for overnight</li>
              </ul>
              
              <h5>News and Events</h5>
              <div class="event-timing">
                <ul>
                  <li><strong>Economic Data:</strong> Usually 8:30 AM EST (before market open)</li>
                  <li><strong>Earnings Reports:</strong> Before open or after close</li>
                  <li><strong>Fed Announcements:</strong> 2:00 PM EST typically</li>
                  <li><strong>Commodity Reports:</strong> Vary by product (e.g., Oil inventory Wednesdays)</li>
                </ul>
              </div>
            </div>
          </div>
        `,
        quiz: {
          question: "When do stock markets typically see the highest trading volume?",
          options: [
          ...
          correct: 2,
          explanation: "The first hour after market open typically sees the highest volume as traders react to overnight news and establish positions for the day."
        }
      }
    }
  },
  ...
  "Understanding Asset Classes": {
    ...
    description: "Learn the unique characteristics, risks, and opportunities of different financial instruments",
    estimatedTime: "45 minutes", 
    category: "foundations",
    lessons: {
      "Asset Class Overview": {
        content: `
          <div class="lesson-intro">
            <p>Financial markets offer various asset classes, each with unique characteristics. While we'll explore all major types, our trading education focuses primarily on three core asset classes: stocks, cryptocurrencies, and commodities.</p>
            <img src="/images/asset-classes-overview.png" alt="Asset Classes Overview" class="lesson-image" />
          </div>
          
          <div class="focus-statement">
            <h4>Our Trading Focus</h4>
            <div class="focus-box">
              <p><strong>Why We Focus on Stocks, Crypto, and Commodities:</strong></p>
              <ul>
                <li><strong>Accessibility:</strong> These markets are easily accessible to retail traders</li>
                <li><strong>Liquidity:</strong> High trading volumes ensure smooth entry and exit</li>
                <li><strong>Education Resources:</strong> Abundant learning materials and real-time data</li>
                <li><strong>Diverse Strategies:</strong> Support both short-term trading and long-term investing</li>
                <li><strong>Clear Regulations:</strong> Well-established rules and protections</li>
              </ul>
              <p class="note-box">While we'll cover other asset classes for educational completeness, our practical examples and strategies focus on these three markets.</p>
            </div>
          </div>

          <div class="all-asset-classes">
            <h4>The Complete Asset Class Landscape</h4>
            <div class="asset-grid">
              <div class="asset-summary primary">
                <h5>🎯 Primary Focus Assets</h5>
                <ul>
                  <li><strong>Stocks:</strong> Company ownership with earnings-driven value</li>
                  <li><strong>Cryptocurrencies:</strong> Digital assets with 24/7 trading</li>
                  <li><strong>Commodities:</strong> Physical goods with supply/demand dynamics</li>
                </ul>
              </div>
              
              <div class="asset-summary secondary">
                <h5>📚 Additional Asset Classes (For Context)</h5>
                <ul>
                  <li><strong>Forex:</strong> Currency pairs with macro drivers</li>
                  <li><strong>Bonds:</strong> Fixed income with interest rate sensitivity</li>
                  <li><strong>Options:</strong> Derivatives for advanced strategies</li>
                  <li><strong>Real Estate:</strong> Property investments (REITs for trading)</li>
                  <li><strong>ETFs:</strong> Baskets of assets for diversification</li>
                </ul>
              </div>
            </div>
          </div>
        `,
        quiz: {
          question: "Which three asset classes are the primary focus of our trading education?",
          options: [
            "Forex, Bonds, and Options",
            "Stocks, Cryptocurrencies, and Commodities",
            "Real Estate, ETFs, and Forex",
            "Bonds, Commodities, and Crypto"
          ],
          correct: 2,
          explanation: "Our trading education focuses on stocks, cryptocurrencies, and commodities due to their accessibility, liquidity, and suitability for retail traders."
        }
      },
      "Stocks: Ownership in Companies": {
        content: `
          <div class="lesson-intro">
            <p>Stocks represent partial ownership in companies. Understanding their unique characteristics helps you trade them effectively.</p>
            <img src="/images/stock-basics.png" alt="Stock Market Basics" class="lesson-image" />
          </div>
          
          <div class="stock-fundamentals">
            <h4>What Makes Stocks Unique</h4>
            <h5>Company Ownership</h5>
            <p>When you buy stock, you own a piece of the company. This ownership includes:</p>
            <ul>
              <li>Voting rights (in most cases)</li>
              <li>Potential dividends from profits</li>
              <li>Capital appreciation as company grows</li>
              <li>Risk of total loss if company fails</li>
            </ul>
            ...
            <div class="category-grid">
              <div class="category-card">
                <h6>By Market Cap</h6>
                <ul>
                  <li><strong>Large Cap:</strong> Over $10B (Apple, Microsoft) - stable, liquid</li>
                  <li><strong>Mid Cap:</strong> $2B-$10B - growth potential with moderate risk</li>
                  <li><strong>Small Cap:</strong> Under $2B - high growth, high volatility</li>
                </ul>
              </div>
              <div class="category-card">
                <h6>By Sector</h6>
                <ul>
                  <li><strong>Technology:</strong> High growth, volatile (NVDA, GOOGL)</li>
                  <li><strong>Healthcare:</strong> Stable with FDA catalyst events</li>
                  <li><strong>Energy:</strong> Commodity price sensitive</li>
                  <li><strong>Financials:</strong> Interest rate sensitive</li>
                </ul>
              </div>
            </div>
            
            <h5>What Moves Stock Prices</h5>
            <div class="price-drivers">
              <h6>Company-Specific Factors:</h6>
              <ul>
                <li><strong>Earnings Reports:</strong> Quarterly results vs. expectations</li>
                <li><strong>Guidance Changes:</strong> Future outlook adjustments</li>
                <li><strong>Product Launches:</strong> New innovations or failures</li>
                <li><strong>Management Changes:</strong> CEO appointments/departures</li>
              </ul>
              
              <h6>Market-Wide Factors:</h6>
              <ul>
                <li><strong>Economic Data:</strong> GDP, employment, inflation</li>
                <li><strong>Interest Rates:</strong> Fed policy impacts valuations</li>
                <li><strong>Sector Rotation:</strong> Money flows between industries</li>
                <li><strong>Global Events:</strong> Geopolitical tensions, pandemics</li>
              </ul>
            </div>
          </div>
          
          <div class="trading-considerations">
            <h4>Stock Trading Realities</h4>
            <h5>Pattern Day Trading Rule</h5>
            <p>US regulation requiring $25,000 minimum for frequent day trading:</p>
            <ul>
              <li>Applies to margin accounts making 4+ day trades in 5 days</li>
              <li>Cash accounts have different restrictions</li>
              <li>Swing trading (holding overnight) avoids this rule</li>
            </ul>
            
            <h5>Gaps and After-Hours Movement</h5>
            <p>Stocks can gap significantly between close and next open:</p>
            <ul>
              <li>Earnings announcements cause 5-20% gaps</li>
              <li>Stop losses don't protect against gaps</li>
              <li>Pre-market trading shows gap direction</li>
            </ul>
          </div>
        `,
        quiz: {
          question: "What is the minimum account size required for pattern day trading stocks in the US?",
          options: [
            "$10,000",
            "$25,000",
            "$50,000",
          ...
          correct: 2,
          explanation: "The Pattern Day Trading rule requires a minimum of $25,000 in a margin account for traders making 4 or more day trades within 5 business days."
        }
      },
      ...
      "Cryptocurrencies: Digital Assets": {
        content: `
          <div class="lesson-intro">
            <p>Cryptocurrencies are digital assets that operate independently of traditional financial systems, offering unique opportunities and risks.</p>
            <img src="/images/crypto-basics.png" alt="Cryptocurrency Basics" class="lesson-image" />
          </div>
          
          <div class="crypto-characteristics">
            <h4>What Makes Crypto Different</h4>
            <h5>Unique Properties</h5>
            <ul>
              <li><strong>24/7 Trading:</strong> Markets never close, constant price discovery</li>
              <li><strong>Global Access:</strong> Trade from anywhere, no geographic restrictions</li>
              <li><strong>High Volatility:</strong> 10-20% daily moves are common</li>
              <li><strong>Decentralization:</strong> No central authority (for most cryptos)</li>
              <li><strong>Lower Barriers:</strong> Start trading with $10, no PDT rules</li>
            </ul>
            
            <h5>Major Cryptocurrencies</h5>
            <div class="crypto-types">
              <div class="crypto-card">
                <h6>Bitcoin (BTC)</h6>
                <p>Digital gold, store of value, market leader</p>
                <ul>
                  <li>Moves entire crypto market</li>
                  <li>Institutional adoption increasing</li>
                  <li>Fixed supply of 21 million</li>
                </ul>
              </div>
              <div class="crypto-card">
                <h6>Ethereum (ETH)</h6>
                <p>Smart contract platform, DeFi backbone</p>
                <ul>
                  <li>Powers decentralized applications</li>
                  <li>Different use case than Bitcoin</li>
                  <li>More volatile than BTC</li>
                </ul>
              </div>
              <div class="crypto-card">
                <h6>Altcoins</h6>
                <p>Thousands of alternatives with varying utility</p>
                <ul>
                  <li>Higher risk/reward potential</li>
                  <li>Many fail or lose 90%+ value</li>
                  <li>Research thoroughly before trading</li>
                </ul>
              </div>
            </div>
            
            <h5>Crypto Market Dynamics</h5>
            <div class="market-factors">
              <h6>Price Drivers:</h6>
              <ul>
                <li><strong>Bitcoin Dominance:</strong> BTC moves affect entire market</li>
                <li><strong>Regulatory News:</strong> Government actions cause sharp moves</li>
                <li><strong>Adoption Events:</strong> Major companies accepting crypto</li>
                <li><strong>Technical Developments:</strong> Protocol upgrades, hacks</li>
                <li><strong>Market Sentiment:</strong> Fear/greed cycles more extreme</li>
              </ul>
              
              <h6>Unique Risks:</h6>
              <ul>
                <li><strong>Exchange Risk:</strong> Platforms can be hacked or fail</li>
                <li><strong>Regulatory Risk:</strong> Sudden bans or restrictions</li>
                <li><strong>Technical Risk:</strong> Lost keys = lost funds forever</li>
                <li><strong>Manipulation:</strong> Less regulated, "whale" movements</li>
              </ul>
            </div>
          </div>
        `,
        quiz: {
          question: "What is the most significant difference between crypto and stock markets?",
          options: [
            "Crypto has lower fees",
            "Crypto trades 24/7 without closing",
            "Crypto is more profitable",
            "Crypto has more regulations"
          ],
          correct: 2,
          explanation: "Unlike stock markets that close daily and on weekends, cryptocurrency markets operate 24/7/365, requiring different risk management approaches."
        }
      },
      ...
      "Commodities: Physical Assets": {
        content: `
          <div class="lesson-intro">
            <p>Commodities are physical goods that form the foundation of the global economy. Understanding their unique drivers is essential for successful trading.</p>
            <img src="/images/commodity-basics.png" alt="Commodity Markets" class="lesson-image" />
          </div>
          
          <div class="commodity-overview">
            <h4>Types of Commodities</h4>
            <div class="commodity-categories">
              <div class="commodity-type">
                <h5>Precious Metals</h5>
                <ul>
                  <li><strong>Gold:</strong> Safe haven, inflation hedge, crisis asset</li>
                  <li><strong>Silver:</strong> Industrial use + investment demand</li>
                  <li><strong>Platinum/Palladium:</strong> Auto industry dependent</li>
                </ul>
                <p class="commodity-note">Inverse correlation with USD strength</p>
              </div>
              
              <div class="commodity-type">
                <h5>Energy</h5>
                <ul>
                  <li><strong>Crude Oil:</strong> Global economic barometer</li>
                  <li><strong>Natural Gas:</strong> Weather and seasonal patterns</li>
                  <li><strong>Gasoline/Heating Oil:</strong> Refined products</li>
                </ul>
                <p class="commodity-note">Geopolitical events cause sharp moves</p>
              </div>
              
              <div class="commodity-type">
                <h5>Agriculture</h5>
                <ul>
                  <li><strong>Grains:</strong> Wheat, corn, soybeans - weather dependent</li>
                  <li><strong>Softs:</strong> Coffee, sugar, cotton - emerging market sensitive</li>
                  <li><strong>Livestock:</strong> Cattle, hogs - disease/feed cost impacts</li>
                </ul>
                <p class="commodity-note">Seasonal patterns and weather reports crucial</p>
              </div>
            </div>
            
            <h4>Commodity Trading Mechanics</h4>
            <h5>Futures Contracts</h5>
            <p>Most commodity trading occurs through futures contracts:</p>
            <ul>
              <li><strong>Standardized Contracts:</strong> Specific quantity, quality, delivery date</li>
              <li><strong>Leverage Built-In:</strong> Control large positions with small margin</li>
              <li><strong>Physical Delivery:</strong> Must exit before expiration or take delivery</li>
              <li><strong>Contango/Backwardation:</strong> Price differences between contract months</li>
            </ul>
            
            <h5>What Drives Commodity Prices</h5>
            <div class="price-factors">
              <h6>Supply Factors:</h6>
              <ul>
                <li>Weather conditions (agriculture)</li>
                <li>Geopolitical disruptions (energy)</li>
                <li>Mining output (metals)</li>
                <li>Storage/inventory levels</li>
              </ul>
              
              <h6>Demand Factors:</h6>
              <ul>
                <li>Economic growth (industrial demand)</li>
                <li>Currency movements (dollar strength)</li>
                <li>Seasonal patterns (heating oil in winter)</li>
                <li>Substitution effects (silver vs gold)</li>
              </ul>
            </div>
            
            <h5>Key Reports and Events</h5>
            <div class="report-schedule">
              <ul>
                <li><strong>Weekly Oil Inventories:</strong> Wednesdays 10:30 AM EST</li>
                <li><strong>USDA Crop Reports:</strong> Monthly grain supply/demand</li>
                <li><strong>Fed Minutes:</strong> Impact on gold through dollar</li>
                <li><strong>Weather Forecasts:</strong> Critical for agricultural futures</li>
              </ul>
            </div>
          </div>
        `,
        quiz: {
          question: "Which commodity is most commonly used as a safe haven during economic uncertainty?",
          options: [
            "Crude Oil",
            "Gold",
            "Wheat",
          ...
          correct: 2,
          explanation: "Gold is traditionally viewed as a safe haven asset that investors flock to during times of economic uncertainty, political tension, or currency devaluation."
        }
      },

      "Other Asset Classes Overview": {
        content: `
          <div class="lesson-intro">
            <p>While our trading strategies focus on stocks, crypto, and commodities, understanding other asset classes provides valuable context for market dynamics and correlations.</p>
            <img src="/images/other-assets.png" alt="Other Asset Classes" class="lesson-image" />
          </div>
          
          <div class="other-assets-section">
            <h4>Foreign Exchange (Forex)</h4>
            <div class="asset-overview">
              <h5>Currency Pair Trading</h5>
              <p>Forex involves trading currency pairs like EUR/USD, GBP/JPY. It's the world's largest market by volume.</p>
              <ul>
                <li><strong>Pros:</strong> Highest liquidity, 24-hour market, low transaction costs</li>
                <li><strong>Cons:</strong> Complex macro analysis, central bank interventions, high leverage risks</li>
                <li><strong>Why We Don't Focus:</strong> Requires deep understanding of global economics and politics</li>
              </ul>
              <p class="correlation-note">Important: USD strength affects commodity prices inversely</p>
            </div>
            
            <h4>Bonds and Fixed Income</h4>
            <div class="asset-overview">
              <h5>Debt Securities</h5>
              <p>Bonds are loans to governments or corporations that pay fixed interest over time.</p>
              <ul>
                <li><strong>Pros:</strong> Steady income, lower volatility, portfolio diversification</li>
                <li><strong>Cons:</strong> Interest rate risk, lower returns, inflation impact</li>
                <li><strong>Trading Note:</strong> Bond prices move inversely to interest rates</li>
              </ul>
              <p class="correlation-note">Important: Rising rates often pressure both stocks and bonds</p>
            </div>
            
            <h4>Options and Derivatives</h4>
            <div class="asset-overview">
              <h5>Advanced Instruments</h5>
              <p>Options give the right (not obligation) to buy/sell assets at specific prices.</p>
              <ul>
                <li><strong>Uses:</strong> Hedging, income generation, speculation with defined risk</li>
                <li><strong>Complexity:</strong> Time decay, implied volatility, Greeks</li>
                <li><strong>Warning:</strong> Can lose 100% quickly, requires advanced knowledge</li>
              </ul>
              <p class="correlation-note">Important: Options on our focus assets (stocks, ETFs) can enhance strategies once mastered</p>
            </div>
            
            <h4>Exchange-Traded Funds (ETFs)</h4>
            <div class="asset-overview">
              <h5>Basket Securities</h5>
              <p>ETFs trade like stocks but hold diversified portfolios of assets.</p>
              <ul>
                <li><strong>Types:</strong> Index ETFs (SPY), Sector ETFs (XLF), Commodity ETFs (GLD)</li>
                <li><strong>Benefits:</strong> Instant diversification, lower fees than mutual funds</li>
                <li><strong>Trading:</strong> Same hours as stocks, can use all order types</li>
              </ul>
              <p class="correlation-note">Useful: ETFs provide exposure to our focus assets with built-in diversification</p>
            </div>
            
            <h4>Real Estate Investment Trusts (REITs)</h4>
            <div class="asset-overview">
              <h5>Property Exposure</h5>
              <p>REITs own income-producing real estate and trade like stocks.</p>
              <ul>
                <li><strong>Income:</strong> Required to pay 90% of profits as dividends</li>
                <li><strong>Sectors:</strong> Residential, commercial, industrial, healthcare</li>
                <li><strong>Correlation:</strong> Sensitive to interest rates like bonds</li>
              </ul>
            </div>
          </div>
          ...
          <div class="key-takeaway">
            ...
            <p>While awareness of all asset classes is valuable, mastering stocks, cryptocurrencies, and commodities provides:</p>
            <ul>
              <li>Clear trading opportunities across different market conditions</li>
              <li>Sufficient diversification for most trading strategies</li>
              <li>Manageable complexity for developing expertise</li>
              <li>Access to both traditional and emerging markets</li>
            </ul>
            <p class="emphasis">Remember: It's better to master three asset classes than to poorly understand ten.</p>
          </div>
        `,
        quiz: {
          question: "Why might rising interest rates negatively affect both bonds AND stocks?",
          options: [
            "They make bonds more attractive, pulling money from stocks",
            "They increase borrowing costs and reduce bond prices",
            "They only affect bonds, not stocks",
            "They cause inflation to rise"
          ],
          correct: 2,
          explanation: "Rising rates increase company borrowing costs (hurting stock valuations) AND reduce existing bond prices (as new bonds offer higher yields), creating a dual negative effect."
        }
      }
    }
  },
      ...
      "Understanding Swing Points": {
        content: `
          ...
          <div class="concept-section">
            ...
            <div class="exam-prep-section">
              <h4>Swing Analysis Exam Preparation</h4>
              <div class="exam-overview">
                <p><strong>What you'll face:</strong> 60-second timer per chart to identify swing highs and lows with precision.</p>
                
                <div class="exam-strategy">
                  <h5>Exam Success Strategy:</h5>
                  <div class="strategy-steps">
                    <div class="step">
                      <h6>Step 1: Quick Scan (10 seconds)</h6>
                      <p>Identify the most obvious peaks and valleys first. Don't overthink minor swings.</p>
                    </div>
                    <div class="step">
                      <h6>Step 2: Validation (30 seconds)</h6>
                      <p>For each potential swing, quickly count 2 candles left and right to confirm.</p>
                    </div>
                    <div class="step">
                      <h6>Step 3: Execution (20 seconds)</h6>
                      <p>Click confidently on validated swings. Hesitation costs valuable time.</p>
                    </div>
                  </div>
                </div>

                <div class="exam-tips">
                  <h5>Speed Tips for Success:</h5>
                  <ul>
                    <li>Focus on significant swings that span major price ranges</li>
                    <li>Ignore minor fluctuations within larger moves</li>
                    <li>Trust your first instinct on obvious swing points</li>
                    <li>Click the exact high/low point, not the candle body</li>
                  </ul>
                </div>

                <div class="practice-drill">
                  <h5>Practice Exercise</h5>
                  <p>Study this chart and identify all valid swing highs. Count how many you find:</p>
                  <img src="/images/swing-practice-chart.png" alt="Swing Point Practice" class="lesson-image" />
                  <details>
                    <summary>Check Your Answer</summary>
                    <div class="answer-explanation">
                      <p><strong>Answer:</strong> 4 valid swing highs identified</p>
                      <p>Remember: Each swing must have 2 lower candles on both sides to be valid.</p>
                      <img src="/images/swing-practice-answers.png" alt="Swing Point Answers" class="lesson-image" />
                    </div>
                  </details>
                </div>

                <div class="ready-to-test">
                  <h4>Test Your Swing Identification Skills</h4>
                  <p>Put your speed and accuracy to the test with real market charts.</p>
                  <a href="/chart-exam/swing-analysis" class="test-link">
                    <i class="fas fa-chart-line"></i>
                    Take Swing Analysis Exam
                  </a>
                </div>
              </div>
            </div>
  ...
  "Fibonacci Analysis": {
    ...
    lessons: {
      "Fibonacci Retracement Exam Mastery": {
        content: `
          <div class="lesson-intro">
            <p>Master Fibonacci retracements for both trading and the timed Fibonacci exam. This lesson bridges theoretical knowledge with practical exam execution under time pressure.</p>
            <img src="/images/fibonacci-exam-overview.png" alt="Fibonacci Exam Overview" class="lesson-image" />
          </div>

          <div class="exam-specific-training">
            <h4>Fibonacci Retracement Exam Challenge</h4>
            <div class="exam-format">
              <p><strong>Exam Format:</strong> Identify correct swing points and draw accurate Fibonacci retracements within the time limit.</p>
              
              <div class="exam-rules">
                <h5>Exam Mechanics:</h5>
                <ul>
                  <li>90 seconds per chart</li>
                  <li>Click swing high first, then swing low</li>
                  <li>Accuracy in swing identification is critical</li>
                  <li>Wrong swing points result in zero score for that chart</li>
                </ul>
              </div>
            </div>

            <h4>Step-by-Step Fibonacci Drawing Strategy</h4>
            <div class="drawing-methodology">
              <div class="step-breakdown">
                <div class="step-card">
                  <h5>Step 1: Identify the Primary Move (15 seconds)</h5>
                  <p>Locate the most significant price move on the chart - typically the largest swing that spans the majority of the visible price range.</p>
                  <div class="identification-tips">
                    <strong>Quick Identification:</strong> Look for moves spanning 50%+ of chart height. Ignore minor fluctuations.
                  </div>
                  <img src="/images/fib-step-1-identification.png" alt="Identify Main Move" class="lesson-image" />
                </div>

                <div class="step-card">
                  <h5>Step 2: Locate Swing High (25 seconds)</h5>
                  <p>Find the absolute highest point of the identified move. This should be a clear peak with lower candles on both sides.</p>
                  <div class="precision-tip">
                    <strong>Precision Point:</strong> Click the exact high of the highest candle, not the candle body.
                  </div>
                  <img src="/images/fib-step-2-swing-high.png" alt="Swing High Location" class="lesson-image" />
                </div>

                <div class="step-card">
                  <h5>Step 3: Locate Swing Low (25 seconds)</h5>
                  <p>Find the absolute lowest point of the move. Should be a clear valley with higher candles on both sides.</p>
                  <div class="selection-criteria">
                    <strong>Selection Criteria:</strong> If multiple lows appear similar, choose the one that generated the strongest reaction.
                  </div>
                  <img src="/images/fib-step-3-swing-low.png" alt="Swing Low Location" class="lesson-image" />
                </div>

                <div class="step-card">
                  <h5>Step 4: Execute Draw (25 seconds)</h5>
                  <p>Click high point first, then low point. Fibonacci levels will automatically generate.</p>
                  <div class="validation-check">
                    <strong>Quick Validation:</strong> 50% level should bisect your selected move approximately in the middle.
                  </div>
                </div>
              </div>
            </div>

            <h4>Timed Practice Scenarios</h4>
            <div class="practice-scenarios">
              <div class="scenario">
                <h5>Practice Round 1: Uptrend Retracement</h5>
                <p>Set a 90-second timer. Identify swing points and mentally place Fibonacci levels.</p>
                <img src="/images/fib-practice-uptrend.png" alt="Uptrend Practice" class="lesson-image" />
                <details>
                  <summary>View Solution</summary>
                  <div class="solution-breakdown">
                    <p><strong>Correct Swing Points:</strong></p>
                    <ul>
                      <li>Swing Low: $42,150 (at 14:30 timestamp)</li>
                      <li>Swing High: $45,800 (at 18:45 timestamp)</li>
                      <li>Key Fib Levels: 38.2%, 50%, 61.8%</li>
                    </ul>
                    <img src="/images/fib-practice-uptrend-solution.png" alt="Uptrend Solution" class="lesson-image" />
                  </div>
                </details>
              </div>

              <div class="scenario">
                <h5>Practice Round 2: Downtrend Retracement</h5>
                <p>Another 90-second challenge with a downward move. Remember to start from swing high for downtrends.</p>
                <img src="/images/fib-practice-downtrend.png" alt="Downtrend Practice" class="lesson-image" />
                <details>
                  <summary>Check Solution</summary>
                  <div class="solution-breakdown">
                    <p><strong>Correct Approach:</strong></p>
                    <ul>
                      <li>Swing High: $48,200 (at 09:15 timestamp)</li>
                      <li>Swing Low: $44,600 (at 16:30 timestamp)</li>
                      <li>Watch for bounce at 38.2% or 61.8% levels</li>
                    </ul>
                    <img src="/images/fib-practice-downtrend-solution.png" alt="Downtrend Solution" class="lesson-image" />
                  </div>
                </details>
              </div>

              <div class="scenario advanced">
                <h5>Advanced Challenge: Multiple Swing Options</h5>
                <p>This chart contains multiple potential swing points. Choose the most significant move for your Fibonacci analysis.</p>
                <img src="/images/fib-practice-advanced.png" alt="Advanced Challenge" class="lesson-image" />
                <div class="strategy-hint">
                  <strong>Strategy Hint:</strong> Focus on the move with the largest price range and clearest trend direction.
                </div>
              </div>
            </div>

            <h4>Exam Performance Optimization</h4>
            <div class="performance-framework">
              <h5>Pre-Exam Mental Preparation:</h5>
              <div class="mental-prep">
                <ul>
                  <li>Review swing point identification rules</li>
                  <li>Practice quick visual scanning techniques</li>
                  <li>Set expectation for 90-second completion</li>
                  <li>Focus on accuracy over speed initially</li>
                </ul>
              </div>

              <h5>During-Exam Time Management:</h5>
              <div class="time-allocation">
                <ol>
                  <li><strong>0-15s:</strong> Scan for primary trend and major move</li>
                  <li><strong>15-40s:</strong> Identify and validate swing high</li>
                  <li><strong>40-65s:</strong> Identify and validate swing low</li>
                  <li><strong>65-80s:</strong> Execute the Fibonacci drawing</li>
                  <li><strong>80-90s:</strong> Quick validation and proceed</li>
                </ol>
              </div>
              ...
              <div class="mistake-prevention">
                <ul>
                  <li>Don't second-guess obvious swing points</li>
                  <li>Avoid perfectionism - good enough beats perfect</li>
                  <li>Don't spend excessive time on borderline swings</li>
                  <li>Trust your initial visual assessment</li>
                </ul>
              </div>
            </div>

            <div class="ready-to-test">
              <h4>Ready for the Fibonacci Exam?</h4>
              <p>Test your Fibonacci drawing skills with real market data under exam conditions.</p>
              <a href="/chart-exam/fibonacci-retracement" class="test-link">
        ...
        `,
        quiz: {
          question: "In the Fibonacci exam, what's the most critical factor for achieving a high score?",
          options: [
            "Drawing all possible Fibonacci levels",
            "Completing each chart in under 30 seconds",
            "Accurately identifying the correct swing high and low points",
            "Using advanced Fibonacci extensions"
          ],
          correct: 3,
          explanation: "Accurate swing point identification is essential - incorrect swing points result in zero score regardless of drawing technique or speed."
        }
      },
