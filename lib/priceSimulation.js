...
// Export for CommonJS only (remove ES6 export that's causing the error)
module.exports = { getPriceSimulator };
module.exports.getPriceSimulator = getPriceSimulator;