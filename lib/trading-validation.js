...
const { SANDBOX_ASSETS } = require('./sandbox-constants');
 ...
 */
export function validateQuantity(quantity, symbol, currentPrice) {
  // Type validation
 ...
 */
export function validatePrice(price, currentPrice, side) {
 ...
 */
export function validatePositionSize(quantity, price, leverage, portfolioBalance) {
