      ...
      "Market Structure Basics": {
        content: `
          <div class="lesson-intro">
            ...
            <img src="/IMG/Range.png" alt="Market Structure Example" class="lesson-image" />
          </div>
      ...
      "Understanding Swing Points": {
        content: `
          <div class="lesson-intro">
            ...
            <img src="/IMG/SwingPoints.png" alt="Swing Points Example" class="lesson-image" />
          </div>
      ...
      "Trend Analysis Fundamentals": {
        content: `
          <div class="lesson-intro">
            ...
            <img src="/IMG/Practice.png" alt="Trend Analysis" class="lesson-image" />
          </div>
      ...
      "Capital Protection Basics": {
        content: `
          <div class="lesson-intro">
            ...
            <img src="/IMG/DiscountPremiumLong.png" alt="Risk Management" class="lesson-image" />
          </div>
      ...
      "Position Sizing Fundamentals": {
        content: `
          <div class="lesson-intro">
            ...
            <img src="/IMG/DiscountPremiumShort.png" alt="Position Sizing" class="lesson-image" />
          </div>
      ...
      "Advanced Swing Analysis": {
        content: `
          <div class="lesson-intro">
            ...
            <img src="/IMG/SwingHigh.png" alt="Advanced Swing Analysis" class="lesson-image" />
          </div>
      ...
      "Liquidity Pool Analysis": {
        content: `
          <div class="lesson-intro">
            ...
            <img src="/IMG/OldH&L.png" alt="Liquidity Analysis" class="lesson-image" />
          </div>
          ...
          <div class="liquidity-types">
            ...
            <div class="point-grid">
              <div class="point-card">
                ...
                <img src="/IMG/SwingHigh.png" alt="Buy-Side Liquidity" class="concept-image" />
                <p>Stop losses from short positions sitting above swing highs</p>
              </div>
              <div class="point-card">
                <h5>Sell-Side Liquidity</h5>
                <img src="/IMG/SwingLow.png" alt="Sell-Side Liquidity" class="concept-image" />
      ...
      "FVG Fundamentals": {
        content: `
          <div class="lesson-intro">
            ...
            <img src="/IMG/FVG_Description.png" alt="FVG Fundamentals" class="lesson-image" />
          </div>
          ...
          <div class="fvg-types">
            ...
            <div class="fvg-type bullish">
              ...
              <img src="/IMG/Bullish_FVG.png" alt="Bullish FVG" class="fvg-image" />
            ...
            <div class="fvg-type bearish">
              ...
              <img src="/IMG/Bearish_FVG_1.png" alt="Bearish FVG" class="fvg-image" />
      ...
      "FVG Trading Strategies": {
        content: `
          <div class="lesson-intro">
            ...
            <img src="/IMG/Bearish_FVG_2.png" alt="FVG Trading" class="lesson-image" />
          </div>
          ...
          <div class="trading-concepts">
            ...
            <div class="concept-card">
              ...
              <img src="/IMG/Bearish_FVG_Reversal.png" alt="FVG Mitigation" class="concept-image" />
              <p>When price returns to partially or completely fill the gap, often providing reversal opportunities</p>
            </div>

            <div class="concept-card">
              <h5>FVG Inversion</h5>
              <img src="/IMG/Fair_Value_Gap_Inversion.png" alt="FVG Inversion" class="concept-image" />
              <p>When a bullish FVG becomes bearish support or a bearish FVG becomes bullish resistance</p>
            </div>

            <div class="concept-card">
              <h5>Consequent Encroachment</h5>
              <img src="/IMG/Consequent_Encroachment.png" alt="Consequent Encroachment" class="concept-image" />
      ...
      "Fibonacci Foundations": {
        content: `
          <div class="lesson-intro">
            ...
            <img src="/IMG/OTE_Midpoint.png" alt="Fibonacci Basics" class="lesson-image" />
          </div>
      ...
      "Advanced Fibonacci Techniques": {
        content: `
          <div class="lesson-intro">
            ...
            <img src="/IMG/OTE_Chart2.png" alt="Advanced Fibonacci" class="lesson-image" />
          </div>
      ...
      "Order Block Mastery": {
        content: `
          <div class="lesson-intro">
            ...
            <img src="/IMG/OrderBlock_InstitutionalSetup.png" alt="Order Blocks" class="lesson-image" />
          </div>
          ...
          <div class="orderblock-types">
            ...
            <div class="ob-type bullish">
              ...
              <img src="/IMG/OrderBlock_BOSSequence.png" alt="Bullish Order Block" class="ob-image" />
            ...
            <div class="ob-type bearish">
              ...
              <img src="/IMG/OrderBlock_HighProbability.png" alt="Bearish Order Block" class="ob-image" />
          ...
          <div class="probability-analysis">
            ...
            <img src="/IMG/OrderBlock_BullishFormation.png" alt="Probability Analysis" class="lesson-image" />
      ...
      "Break of Structure Analysis": {
        content: `
          <div class="lesson-intro">
            ...
            <img src="/IMG/OrderBlock_OBandBOS.png" alt="BOS Analysis" class="lesson-image" />
          </div>
          ...
          <div class="probability-chart">
            ...
            <img src="/IMG/OrderBlock_ProbabilityComparison.png" alt="Probability Comparison" class="lesson-image" />
      ...
      "Institutional Manipulation Tactics": {
        content: `
          <div class="lesson-intro">
            ...
            <img src="/IMG/OrderBlock_LowProbability.png" alt="Manipulation Tactics" class="lesson-image" />
          </div>
          ...
          <div class="manipulation-concepts">
            ...
            <div class="manipulation-type">
              ...
              <img src="/IMG/OrderBlock_ProbabilityComparison.png" alt="Stop Hunt Example" class="manipulation-image" />
            </div>
      ...
      "Smart Money Concepts": {
        content: `
          <div class="lesson-intro">
            ...
            <img src="/IMG/SwingLow.png" alt="Smart Money Concepts" class="lesson-image" />
          </div>
          ...
          <div class="optimal-trade-entry">
            ...
            <div class="ote-examples">
              <div class="ote-card">
                ...
                <img src="/IMG/OTE_Long.png" alt="Bullish OTE" class="ote-image" />
                <p>After liquidity grab below, price returns to OTE zone for institutional buying</p>
              </div>

              <div class="ote-card">
                <h5>Bearish OTE Setup</h5>
                <img src="/IMG/OTE_Short.png" alt="Bearish OTE" class="ote-image" />
      ...
      "Volume Imbalance Analysis": {
        content: `
          <div class="lesson-intro">
            ...
            <img src="/IMG/VolumeImbalanceDefinition.png" alt="Volume Imbalance" class="lesson-image" />
          </div>
      ...
      "Advanced Volume Patterns": {
        content: `
          <div class="lesson-intro">
            ...
            <img src="/IMG/Bullish_FVG_VI_Gap_Comparison.png" alt="Volume Patterns" class="lesson-image" />
          </div>
      ...
      "ICT Scalping Methodology": {
        content: `
          <div class="lesson-intro">
            ...
            <img src="/IMG/OTE_Chart1.png" alt="ICT Methodology" class="lesson-image" />
          </div>
      ...
      "Multi-Timeframe Scalping": {
        content: `
          <div class="lesson-intro">
            ...
            <img src="/IMG/OTE_Chart3.png" alt="Multi-Timeframe Analysis" class="lesson-image" />
          </div>
...
export const isTopicAccessible = (topicLevel, userSubscription, isAdmin = false) => {
  ...
  if (topicLevel === 'intermediate') return ['existing', 'promo', 'paid'].includes(userSubscription);
  if (topicLevel === 'advanced' && ['paid', 'promo'].includes(userSubscription)) return true;
  return false;
};
...
export const getDifficultyMetadata = () => {
  return {
    ...
    advanced: {
      ...
      icon: "fas fa-crown",
      color: "#F44336",
      accessText: "Premium Subscription"
    }
  };
};